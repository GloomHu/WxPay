...
namespace Pay
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        {
            Log.Info(this.GetType().ToString(), "Default page load");
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    Log.Debug("page load", "request openid: " + jsApiPay.openid);
                }
                catch (Exception ex)
                {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (ViewState["openid"] != null)
            {
                ...
                string url = "JsApiPayPage.aspx?openid=" + openid + "&total_fee=" + total_fee+"&orderNo=200115052114140002&payTradeNo=" + new WxPayData().GenerateOutTradeNo();
